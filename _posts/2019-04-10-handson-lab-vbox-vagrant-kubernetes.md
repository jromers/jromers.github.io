...
1. Clone the GitHub repository for Oracle Linux Vagrant boxes (or [download zip-file](https://github.com/oracle/vagrant-boxes/archive/master.zip)).
```
$ git clone https://github.com/oracle/vagrant-boxes      	
$ cd vagrant-boxes/Kubernetes
```
2. Additional Lab exercises files.
```
